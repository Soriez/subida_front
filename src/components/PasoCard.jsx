...
const PasoCard = ({ paso }) => {
    return (
        // Tarjeta de Paso Individual (<article>)
        <article
            key={paso.id}
            // 1. Convertimos el contenedor principal a 'relative'.
            // 2. Mantenemos el padding normal, ya que el número saldrá del flujo.
            // 3. Agregamos h-full y flex flex-col para igualar alturas
            className='bg-white p-6 sm:p-8 rounded-xl shadow-lg border border-gray-200 text-left relative h-full flex flex-col'
        >
